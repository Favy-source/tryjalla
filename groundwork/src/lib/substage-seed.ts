/**
 * SUBSTAGE_SEED — the complete set of ~60 substages for all 10 stages.
 *
 * Used by the create-project edge function to seed substages on every new
 * project. Read-only — never mutated at runtime.
 *
 * Source: Groundwork Engineering Blueprint Part 7.
 */
...
/** Total substage count across all stages (should be 60). */
export const TOTAL_SUBSTAGES = Object.values(SUBSTAGE_SEED).reduce(
